var items_296f5d02_12fd_4166_a7c1_b5e830c9ee3a = 
{
	...
	"greenGem": {
		...
		"itemEffect": "core.status.hero.mdef += 2 * core.status.thisMap.ratio",
		"itemEffectTip": "，护盾+${2 * core.status.thisMap.ratio}",
	...
	"I343": {
		...
		"name": "技能升级卡",
		"canUseItemEffect": "true",
		"itemEffect": "core.openUpgrade(core.status.floorId);",
		"itemEffectTip": "，免费获得一次升级技能的机会"
	},
	"I344": {
		"cls": "items",
		"name": "新物品",
	...
	"I358": {
		...
		"name": "二阶绿宝石",
		"text": "，护盾+${core.values.greenGem}",
		"itemEffect": "core.status.hero.mdef += 4 * core.status.thisMap.ratio",
		"itemEffectTip": "，护盾+${4 * core.status.thisMap.ratio}",
		"useItemEffect": "core.status.hero.mdef += core.values.greenGem",
		"canUseItemEffect": "true"
	},
	"I359": {
