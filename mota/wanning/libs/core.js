...
function core () {
    ...
    this.initStatus = {
        ...
        "globalAttribute": {
            ...
            "statusLeftBackground": main.styles.statusLeftBackground || "linear-gradient(to bottom, black, rgb(0, 98, 105))",
            "statusTopBackground": main.styles.statusTopBackground || "linear-gradient(to right, black, rgb(0, 98, 105))",
            "toolsBackground": main.styles.toolsBackground || "linear-gradient(to right, black, rgb(0, 98, 105))",
